...
def get_pixel_dist(pixel, red, green, blue):
    ...
    """
    r_d = (red - pixel.red)**2
    g_d = (green - pixel.green) ** 2
    b_d = (blue - pixel.blue) ** 2
    color_dist = math.sqrt(r_d + g_d + b_d)
    return color_dist
...
def get_average(pixels):
    ...
    for i in range(length):
        avg_r += pixels[i].red//length
        avg_g += pixels[i].green//length
        avg_b += pixels[i].blue//length
